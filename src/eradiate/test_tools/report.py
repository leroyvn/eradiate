...
class ReportLogger:
    ...
    def info(self, msg: str, also_console: bool = True) -> None:
        """
        Log an informational message to the test report.
        ...
        also_console : bool, optional, default: True
            If ``True``, also echo the message to the console (Robot Framework
            backend only).
        """
        if self._robot is not None:
            self._robot.info(msg, also_console=also_console)
        else:
            _logger.info(msg)
